...
\begin{figure}[htb]
    ...
    \centering
    \includegraphics[width=0.7\textwidth]{figuras/05-desenvolvimento/diagrama_atividades_provisionamento.png}
    \legend{Fonte: Própria do autor (2026).}
\end{figure}
...
\begin{figure}[htb]
    ...
    \centering
    \includegraphics[width=0.9\textwidth]{figuras/05-desenvolvimento/diagrama_sequencia_tenant.png}
    \legend{Fonte: Própria do autor (2026).}
\end{figure}
...
\begin{figure}[htb]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{figuras/05-desenvolvimento/daschboard.png}
    \legend{Fonte: Própria do autor (2026).}
\end{figure}
...
\begin{figure}[htb]
    ...
    \centering
    \includegraphics[width=0.6\textwidth]{figuras/05-desenvolvimento/aceso_user.png}
    \legend{Fonte: Própria do autor (2026).}
\end{figure}

\begin{figure}[htb]
    \centering
    \subfloat[Criação de Usuário Master]{\includegraphics[width=0.45\textwidth]{figuras/05-desenvolvimento/criacao_usuario_master.png}\label{fig:criacao_usuario_master}}
    \hfill
    \subfloat[Criação de Usuário de Empresa]{\includegraphics[width=0.45\textwidth]{figuras/05-desenvolvimento/criacao_usuario_empresa.png}\label{fig:criacao_usuario_empresa}}
...
\begin{figure}[htb]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{figuras/05-desenvolvimento/lista de usuarios cadastrados.png}
    \legend{Fonte: Própria do autor (2026).}
\end{figure}
...
\begin{figure}[htb]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{figuras/05-desenvolvimento/lista_empresas.png}
    \legend{Fonte: Própria do autor (2026).}
\end{figure}
...
\begin{figure}[htb]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{figuras/05-desenvolvimento/lista_bancos.png}
    \legend{Fonte: Própria do autor (2026).}
\end{figure}

\begin{figure}[htb]
    \centering
    \subfloat[Listagem de Planos]{\includegraphics[width=0.45\textwidth]{figuras/05-desenvolvimento/listas_planos.png}\label{fig:listas_planos}}
    \hfill
    \subfloat[Listagem de Licenças]{\includegraphics[width=0.45\textwidth]{figuras/05-desenvolvimento/listas_licenças.png}\label{fig:listas_licenças}}
...
\begin{figure}[htb]
    \centering
    \subfloat[Criação de Planos]{\includegraphics[width=0.45\textwidth]{figuras/05-desenvolvimento/criacao_plano.png}\label{fig:criacao_plano}}
    \hfill
    \subfloat[Emissão de Licença]{\includegraphics[width=0.45\textwidth]{figuras/05-desenvolvimento/criacao_licença.png}\label{fig:criacao_licença}}
...
\begin{figure}[htb]
    ...
    \centering
    \includegraphics[width=0.8\textwidth]{figuras/05-desenvolvimento/alteração_plano_empresa.png}
    \legend{Fonte: Própria do autor (2026).}
\end{figure}
