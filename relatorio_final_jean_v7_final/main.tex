...
\usepackage{tikz}               % Para criação de diagramas técnicos
...
\titulo{Desenvolvimento de um \textit{Hub} Administrativo Centralizado para Gestão de Ecossistema \textit{SaaS}: Projeto Oficina Master}
\autor{Jean KronbAuer de Moura}
\local{Ijuí/RS}
\data{2026}
...
\begin{siglas}
    ...
    \item[DI] \textit{Dependency Injection} (Injeção de Dependência)
    \item[ERP] \textit{Enterprise Resource Planning}
    \item[IBPT] Instituto Brasileiro de Planejamento e Tributação
    ...
    \item[NCM] Nomenclatura Comum do Mercosul
    ...
    \item[SEFAZ] Secretaria da Fazenda
    ...
    \item[WIP] \textit{Work In Progress}
\end{siglas}
