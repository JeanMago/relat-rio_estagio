...
\begin{figure}[htb]
    ...
    \begin{tikzpicture}[node distance=2cm, auto, >=latex']
        ...
        \node [draw, rectangle, fill=orange!5, below of=root, xshift=-4cm] (auth) {AuthStore\\(User/Token)};
        \node [draw, rectangle, fill=orange!5, below of=root, xshift=0cm] (tenant) {TenantStore\\(Contexto/Empresa)};
        \node [draw, rectangle, below of=root, xshift=4cm, fill=orange!5] (ui) {UIStore\\(Temas/Notificações)};
